...
> 3. {% tool [Multivariate](toolshed.g2.bx.psu.edu/repos/ethevenot/multivariate/Multivariate/2.3.10) %} with the following parameters:
...
Questions
1. The picture represents the PCA scores plot of components t1 (51% of total variability) and t2 (18% of total variability) with sample labels coloured according to the values from the Treatment column of the sampleMetadata file.
