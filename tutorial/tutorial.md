...
>
> 4. {% tool [MultiQC](toolshed.g2.bx.psu.edu/repos/iuc/multiqc/multiqc/1.24.1+galaxy0) %} to aggregate the Falco reports with the following parameters:
>    - In *"Results"*:
>        - *"Results"*
>            - *"Which tool was used generate logs?"*: `FastQC`
>
>              **Falco** is a drop-in replacement for *FastQC* and we can pass its output to MultiQC as if it had been generated by the original tool.
>                - In *"FastQC output"*:
